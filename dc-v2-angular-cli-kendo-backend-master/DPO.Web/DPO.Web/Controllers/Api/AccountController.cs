...
namespace DPO.Web.Controllers
{
    ...
    {
        readonly UserServiceLight userServiceLight = new UserServiceLight();
        readonly UserServices userService = new UserServices();
        readonly AccountServices accountService = new AccountServices();
        readonly BusinessServices businessService = new BusinessServices();
        readonly HtmlServices htmlService = new HtmlServices();

        readonly BaseController MvcAccountController = new AccountController();
