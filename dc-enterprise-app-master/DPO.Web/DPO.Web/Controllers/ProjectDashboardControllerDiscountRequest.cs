    ...
    public partial class ProjectDashboardController
    {
        ...
        public ActionResult DiscountRequest(DiscountRequestModel model)
        {
            ...
            if (ProcessServiceResponse(this.ServiceResponse))
            {
                ...
                emailModel.Subject = string.Format("DPO Discount Request" + "-Business: " + this.CurrentUser.BusinessName + "-Project: " + model.Project.Name);
                ...
                if (model.Project.OwnerId != CurrentUser.UserId && model.Project.OwnerId != null)
                {
        ...
        [HttpPost]
        public ActionResult SendDiscountRequestEmail(DiscountRequestModel model)
        {
        ...
        private void SendApprovalRejectionEmail(DiscountRequestModel model)
        {
            ...
            {
                emailModel.Subject = string.Format("DPO Discount Approved" + "-Business: " + model.BusinessName + "-Project: " + model.Project.Name);
            }
            else
            {
                emailModel.Subject = string.Format("DPO Discount Not Approved" + "-Business: " + model.BusinessName + "-Project: " + model.Project.Name);
            }
            ...
            business.DVPEmail = discountRequestService.GetEmailByUserId(business.DVP_UserId);
            business.TSMEmail = discountRequestService.GetEmailByUserId(business.TSM_UserId);
            business.ASMEmail = discountRequestService.GetEmailByUserId(business.ASM_UserId);
            business.RSMEmail = discountRequestService.GetEmailByUserId(business.RSM_UserId);
            business.CSMEmail = discountRequestService.GetEmailByUserId(business.CSM_UserId);
