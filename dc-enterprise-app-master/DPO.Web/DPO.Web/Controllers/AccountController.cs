...
namespace DPO.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        DaikinUniversityApiServices daikinUniversityApiServices = new DaikinUniversityApiServices();
        //This can be disabled. -- Huy Nguyen
        [HttpGet]
        ...
        public JsonResult RegisterUser(UserModel model)
        {
            ...
            //model.ApprovalProcesses = ApprovalProcessEnum.Created;
            ...
            if (this.ServiceResponse.IsOK)
            {
                if (model.IsRegistering)
                {
                    ...
                    try
                    {
                        daikinUniversityApiServices.UserRegistration(model);
