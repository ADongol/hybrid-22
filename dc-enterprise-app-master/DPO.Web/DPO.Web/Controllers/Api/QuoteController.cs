...
namespace DPO.Web.Controllers
{
    ...
    public class QuoteController : BaseApiController
    {
        ...
        [HttpGet]
        public ServiceResponse DuplicateQuote(long projectId, long quoteId) {
            QuoteModel quoteModel = quoteService.GetQuoteModel(this.CurrentUser, projectId, quoteId).Model as QuoteModel;
            this.ServiceResponse = quoteService.Duplicate(this.CurrentUser, quoteModel);
