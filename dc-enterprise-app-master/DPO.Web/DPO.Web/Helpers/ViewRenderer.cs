...
namespace DPO.Web.Helpers
{
    public class ViewRenderer
    {
        ...
        /// </param>
        /// <param name="model">The model to render the view with</param>
        /// <param name="writer">todo: describe writer parameter on RenderView</param>
        /// <returns>String of the rendered view or null on error</returns>
        ...
        /// </summary>
        /// <param name="routeData">todo: describe routeData parameter on CreateController</param>
        /// <param name="parameters">todo: describe parameters parameter on CreateController</param>
