...
namespace DPO.Web.Helpers
{
    ...
    {
        public static MvcHtmlString DropDownProductPowerVoltagesFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, 
        ...
        public static MvcHtmlString DropDownProductPowerVoltagesFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, 
            Expression<Func<TModel, TProperty>> expression, DropDownModel model, string optionLabel, string emptyText, object htmlAttributes)
        {
