...
import { LCSplitMatchupService } from '../../services/lc-split-matchup.service';
...
export class LCSplitMatchupComponent implements OnInit {
    ...
    constructor(private router: Router, private route: ActivatedRoute, private toastrSvc: ToastrService, 
        ...
        private lcMatchupServiceSvc: LCSplitMatchupService
    ) {
    ...
    public getResult() {
        ...
        if (this.validateInput()) {
            ...
            this.lcMatchupServiceSvc.getSystemMatchupList(params).then((resp: any) => {
                if (!resp.error) {
    ...
    public setupTonnageDDL() {
        ...
        this.lcMatchupServiceSvc.getTonnageList().then((resp: any) => {
            if (resp) {
