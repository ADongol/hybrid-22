...
export class DiscountRequestService {
    ...
    public sendDiscountRequestEmail(discountRequest: any) {
        return this.http.post("/ProjectDashboard/SendDiscountRequestEmail", discountRequest, { headers: this.headers })
            .map(this.extractData)
            .catch(this.handleError);
    }

    public approveDiscountRequest(discountRequest: any): Observable<any> {
        //MVC Controller
    ...
    public rejectDiscountRequest(discountRequest: any): Observable<any> {
        //MVC Controller
    ...
    public getMostRecentDiscountRequestModel(projectId: any, quoteId: any): Observable<any> {
