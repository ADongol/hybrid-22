...
import { TransferProjectPopupComponent } from './transfer-project-popup.component';
import { DeleteProjectsPopupComponent } from './delete-projects-popup.component';
import { ExportProjectsPopupComponent } from './export-projects-popup.component';
...
export class ProjectGridComponent implements OnInit, AfterViewInit {
    ...
    constructor(private toastrSvc: ToastrService, private userSvc: UserService,
        private http: Http, private enums: Enums, private projectSvc: ProjectService) {
    }
    ...
    public displayStrategicProject(isStrategicProject: any, selectedStrategicTypes: any, strategicTypes: any) {
