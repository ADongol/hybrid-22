...
import { QuotePackageGridComponent } from '../../submittal/components/quote-package-grid.component';
import { SubmittalPackageService } from '../../submittal/services/submittal-package.service';
...
export class UploadFilesModalComponent implements OnDestroy {
