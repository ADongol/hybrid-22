...
var SplitSystemConfiguratorComponent = /** @class */ (function () {
    ...
    function SplitSystemConfiguratorComponent(router, route, toastrSvc, userSvc, systemAccessEnum, productSvc, basketSvc, SplitSystemConfiguratorSvc) {
        this.router = router;
        this.route = route;
    ...
    ], SplitSystemConfiguratorComponent.prototype, "blockUI", void 0);
