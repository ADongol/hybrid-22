...
var SystemConfiguratorComponent = /** @class */ (function () {
    function SystemConfiguratorComponent(router, route, userSvc, systemAccessEnum, webconfigSvc, toastrSvc, productSvc, basketSvc, SystemConfiguratorSvc) {
        this.router = router;
        this.route = route;
    ...
    ], SystemConfiguratorComponent.prototype, "blockUI", void 0);
    SystemConfiguratorComponent = __decorate([
        core_1.Component({
            ...
            //],
            styleUrls: [
                'app/content/kendo/all-kendo-default-custom.css'
            ],
            templateUrl: 'app/tools/systemConfigurator/system-configurator.component.html'
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof router_1.Router !== "undefined" && router_1.Router) === "function" && _b || Object, typeof (_c = typeof router_1.ActivatedRoute !== "undefined" && router_1.ActivatedRoute) === "function" && _c || Object, user_service_1.UserService, systemAccessEnum_1.SystemAccessEnum,
            webconfig_service_1.WebConfigService, toastr_service_1.ToastrService,
