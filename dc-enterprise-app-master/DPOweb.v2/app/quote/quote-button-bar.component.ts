...
export class QuoteButtonBarComponent implements OnInit {
    ...
    requestDiscount() {
        this.actionUrl = "/v2/#/discountRequest/0/" + this.quote.projectId + "/" + this.quote.quoteId;
        this.setupInventoryCheckModal();
    }
    ...
    requestCommission() {
        if (this.quote.commissionRequestId != null && this.quote.commissionRequestStatusTypeId != this.enums.CommissionRequestStatusTypeEnum.Deleted) {
            this.actionUrl = "/v2/#/commissionRequest/" + this.quote.commissionRequestId + "/" + this.quote.projectId + "/" + this.quote.quoteId;
        } else {
            this.actionUrl = "/v2/#/commissionRequest/0/" + this.quote.projectId + "/" + this.quote.quoteId;
        }
