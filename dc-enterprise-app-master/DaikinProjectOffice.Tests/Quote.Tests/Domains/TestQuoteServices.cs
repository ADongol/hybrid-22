...
namespace DaikinProjectOffice.Tests
{
   ...
   public partial class TestQuoteServices : TestAdmin
   {
      ...
      BasketServices serviceBasket;
        SubmittalPackageServices submittalService;
        ...
        public TestQuoteServices()
        {
            ...
            submittalService = new SubmittalPackageServices(this.TContext);
        ...
        {
                SubmittalPackageModel model = new SubmittalPackageModel();
                model.QuoteId = _quoteId;

                this.Response = submittalService.GetQuoteQuotePackage(user, model);
                Assert.That(this.Response.HasError, Is.EqualTo(false));

                model = this.Response.Model as SubmittalPackageModel;
