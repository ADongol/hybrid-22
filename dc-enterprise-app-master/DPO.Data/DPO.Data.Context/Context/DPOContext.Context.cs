...
public partial class DPOContext : DbContext
{
    ...
    public virtual DbSet<ProjectStrategicType> ProjectStrategicTypes { get; set; }

    public virtual DbSet<StrategicType> StrategicTypes { get; set; }

    public virtual DbSet<DCMaintenanceConfig> DCMaintenanceConfigs { get; set; }

    public virtual DbSet<EfficiencyType> EfficiencyTypes { get; set; }

    public virtual DbSet<OrderExpediteInfo> OrderExpediteInfoes { get; set; }

    public virtual DbSet<OrderAttachmentType> OrderAttachmentTypes { get; set; }

    public virtual DbSet<LmsCourseSession> LmsCourseSessions { get; set; }

    public virtual DbSet<LmsFacility> LmsFacilities { get; set; }
    ...
    public virtual IQueryable<Group> FnGetGroupsAboveGroupId(Nullable<long> groupId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Group>("[DPOContext].[FnGetGroupsAboveGroupId](@GroupId)", groupIdParameter);
    }
    ...
    public virtual IQueryable<Group> FnGetGroupsBelowGroupId(Nullable<long> groupId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Group>("[DPOContext].[FnGetGroupsBelowGroupId](@GroupId)", groupIdParameter);
    }
    ...
    public virtual IQueryable<Permission> FnGetPermissionsUnderPermissionId(Nullable<long> permissionId)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Permission>("[DPOContext].[FnGetPermissionsUnderPermissionId](@PermissionId)", permissionIdParameter);
    }
    ...
    public virtual IQueryable<VwProductNote> FnProductNotes(Nullable<long> productId, Nullable<int> productNoteTypeId)
    {
        ...
        var productNoteTypeIdParameter = productNoteTypeId.HasValue ?
            new ObjectParameter("ProductNoteTypeId", productNoteTypeId) :
            new ObjectParameter("ProductNoteTypeId", typeof(int));


        return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<VwProductNote>("[DPOContext].[FnProductNotes](@ProductId, @ProductNoteTypeId)", productIdParameter, productNoteTypeIdParameter);
    }
