 ...
 : IConcurrency 
{
    ...
    public string ERPBusinessName { get; set; }

    public Nullable<long> DVP_UserId { get; set; }

    public Nullable<long> TSM_UserId { get; set; }

    public Nullable<long> ASM_UserId { get; set; }

    public Nullable<long> RSM_UserId { get; set; }

    public Nullable<long> CSM_UserId { get; set; }

    public Nullable<long> SupportRep_UserId { get; set; }

    public Nullable<long> VRVLCRSM_UserId { get; set; }

    public string CRM_AccountStatus { get; set; }
