...
namespace DPO.Data
{
    public partial class Repository
    {
        ...
        public OrderExpediteInfo OrderExpediteCreate(long orderId)
        {
            var entity = new OrderExpediteInfo();
            entity.OrderExpediteInfoId = this.Context.GenerateNextLongId();
            entity.OrderId = orderId;
            return entity;
        }
        ...
        public IQueryable<Order> QueryOrderViewableBySearch(UserSessionModel user, SearchOrders search)
        {
            ...
            //****
            // Commented by Anand to fix the non stop spinning of the orders list page.
            // Filter, and Sort is taken care by Angular, and no need for query to be counted as well.
            /***/
