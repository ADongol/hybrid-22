            ...
            get
            {
                ...
                switch (this.SubmittalSheetTypeId)
                {
                    ...
                    case SubmittalSheetTypeEnum.PackagedGasElectric:
                        ...
                        break;
                    case SubmittalSheetTypeEnum.MultiZoneIndoor:
                        submittalsheet += "_MultiZone_Indoor";
                        break;
                    case SubmittalSheetTypeEnum.MultiZoneOutdoor:
                        submittalsheet += "_MultiZone_Outdoor";
                        break;
                    case SubmittalSheetTypeEnum.SingleZoneCooling:
                        submittalsheet += "_SingleZoneCooling";
                        break;
                    case SubmittalSheetTypeEnum.SingleZoneHP:
                        submittalsheet += "_SingleZoneHP";
                        break;
            ...
            get
            {
                ...
                switch (this.SubmittalSheetTypeId)
                {
                    ...
                    case SubmittalSheetTypeEnum.PackagedGasElectric:
                        ...
                        break;
                        //Fix the below for angular after testing LMW 090118
                        //case SubmittalSheetTypeEnum.MultiZoneIndoor:
                        //    submittalsheet = "Submittal_Template_Indoor";
                        //    break;
                        //case SubmittalSheetTypeEnum.MultiZoneOutdoor:
