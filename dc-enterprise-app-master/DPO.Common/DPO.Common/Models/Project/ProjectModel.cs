...
namespace DPO.Common
{
    ...
    public class ProjectModel : PageModel
    {
        public ProjectModel()
        {
            ...
            SelectedStrategicTypes = new List<long>();
        }
        ...
        public bool IsStrategicProject { get; set; }
        public List<long> SelectedStrategicTypes { get; set; }
        public DropDownModel StrategicTypes { get; set; }
