...
namespace DPO.Common
{
    public class BusinessModel : PageModel, IAddressContactModel
    {
        ...
        public long? DVP_UserId { get; set; }

        public long? TSM_UserId { get; set; }

        public long? ASM_UserId { get; set; }

        public long? RSM_UserId { get; set; }

        public long? CSM_UserId { get; set; }
