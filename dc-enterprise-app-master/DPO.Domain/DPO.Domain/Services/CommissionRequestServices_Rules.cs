    ...
    public partial class CommissionRequestServices : BaseServices
    {
        ...
        public override void RulesOnAdd(UserSessionModel user, object entity)
        {
            ...
            if (commissionRequest.Quote == null)
            {
                ...
                if (commissionRequest.Quote.AwaitingCommissionRequest)
                {
                    ...
                    this.Response.Messages.AddError(Resources.ResourceModelProject.MP143);
                    return;
                }
            }
        ...
        private void RecalculateCommission(UserSessionModel user, CommissionRequest entity)
        {
            if (entity.CommissionRequestStatusTypeId != (byte)CommissionRequestStatusTypeEnum.Approved)
            {
                ...
                entity.RequestedCommissionVRV = entity.TotalNetVRV * (entity.RequestedCommissionPercentVRV);
                ...
                entity.RequestedCommissionSplit = entity.TotalNetSplit * (entity.RequestedCommissionPercentSplit);
                ...
                entity.RequestedCommissionUnitary = entity.TotalNetUnitary * (entity.RequestedCommissionPercentUnitary);
                ...
                entity.RequestedCommissionLCPackage = entity.TotalNetLCPackage * (entity.RequestedCommissionPercentLCPackage);
                ...
                entity.RequestedCommissionPercent = (entity.RequestedCommissionTotal / entity.TotalNet);
